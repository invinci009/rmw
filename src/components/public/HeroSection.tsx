                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className={`transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                        ...
                        <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-full px-5 py-2.5 mb-6 border border-white/20">
                            ...
                            <span className="text-white text-sm font-medium">Since 1972 • 50+ Years of Excellence</span>
                        </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-[1.1]">
                            ...
                            <span className="block text-2xl md:text-3xl lg:text-4xl mt-3 font-semibold text-white/90">
                                in Patna, Bihar
                            </span>
                        </h1>
                        ...
                        <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-xl leading-relaxed">
                            Transform your vehicle with our expert detailing, Paint Protection Film,
                            ceramic coating, custom wraps, and performance modifications.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3 mb-8">
                            ...
                            <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                                ...
                                <span className="text-white text-sm font-medium">PPF & Ceramic</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link
                                href="/booking"
                                className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/40 hover:scale-105 overflow-hidden"
                            >
                                {/* Shimmer effect */}
                            ...
                            <a
                                href="tel:9931759995"
                                className="group inline-flex items-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:bg-gray-50 hover:scale-105 hover:shadow-lg"
                            >
                                <Phone size={20} />
                                Call Now
                            </a>
